...
class Comptable(models.Model):
    ...
    email_envoi_facture = models.CharField("2mail d'nvoi de facture",max_length=80,null=True)
    telephone = models.CharField("Telephone ",max_length=50,null=True)
    mobile = models.CharField("Mobile ",max_length=50,null=True)
    def __str__(self):
...
class ServiceGestion(models.Model):
    nom_complet = models.CharField("Nom Complet",max_length=100,null=True)
    email = models.CharField("Emailt",max_length=100,null=True)
    telephone = models.CharField("Telephone",max_length=100,null=True)
    mobile = models.CharField("Mobilet",max_length=100,null=True)
...
class Concession(models.Model):
    agent_rattache = models.ForeignKey(Agent,on_delete=models.CASCADE,related_name="agent_rattachee",null=True)
...
class Client(models.Model): 
    ...
    type = models.CharField('Type de client',max_length=30,default="particulier",null=True) 
    ...
    ville = models.CharField("Ville",max_length=80,default="Vide",null=True)
    ...
    created_at = models.DateTimeField("Date ajout",auto_now_add=False,null=True)
    updated_at = models.DateTimeField("Date ajout",auto_now_add=False,null=True)
